...
class AutomaticNotificationService
{
    ...
    private static function buildContext(
        ...
        return [
            ...
            'invoice_id' => (string) ($receivable->receivable_number ?: $receivable->nosso_numero ?: ('#' . $receivable->id)),
            'nosso_numero' => (string) ($receivable->nosso_numero ?: ''),
            'charge_title' => $chargeTitle,
            'issue_date' => NotifierService::formatDate($receivable->issue_date),
            'invoice_issue_date' => NotifierService::formatDate($receivable->issue_date),
            'due_date' => NotifierService::formatDate($receivable->due_date),
            'invoice_due_date' => NotifierService::formatDate($receivable->due_date),
