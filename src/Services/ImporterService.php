...
class ImporterService {
    ...
    public static function processCustomerBatch(int $companyId, int $batchId, array $records) {
        foreach ($records as $index => $row) {
            ...
            $email = self::pickValue($row, ["email_cobranca", "email", "email_billing"]);
            ...
            StagingCustomer::create([
                ...
                'normalized_name' => strval($fullName), // Usually another step converts string
    ...
    public static function processReceivableBatch(int $companyId, int $batchId, array $records) {
        foreach ($records as $index => $row) {
            ...
            $recNumber = self::pickValue($row, ["numero_titulo", "titulo", "receivable_number"]);
            ...
            StagingReceivable::create([
                ...
                'normalized_customer_name' => strval($customerName),
